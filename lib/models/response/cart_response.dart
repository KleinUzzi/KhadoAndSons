...
class CartItem {
    ...
    CartItem({this.addedQty, this.author_name, this.book_id, this.cart_mapping_id, this.cash_on_delivery, this.cgst, this.discount, this.front_cover, this.igst, this.in_stock, this.inventory_id, this.name, this.price, this.sgst, this.shipping_cost, this.title, this.user_id});
