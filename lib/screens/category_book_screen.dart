...
class _CategoryBooksState extends State<CategoryBooks>  with AfterLayoutMixin<CategoryBooks>{
      ...
      if (bool) {
        ...
        subCategories(request).then((result) {
          ...
          if(response.data!=null && response.data.isNotEmpty){
            setState(() {
              subCatList.clear();
              subCatList.add(Category(categoryId: widget.categoryId,subCategoryId: "",name: "ALL BOOKS"));
  ...
  Widget build(BuildContext context) {
    final appBar = AppBar(
      ...
      title: subCatList.isEmpty?Column(
        ...
        child: DropdownButton(
          ...
          items: subCatList.map((category) {
            return DropdownMenuItem(
              child: Row(
                children: <Widget>[
                  headingText(context,category.name!=null?category.name:""),
                ],
              ),
              value: category.name,
            );
